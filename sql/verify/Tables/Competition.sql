-- Verify jcl:Tables/Competition on pg
...
begin
	...
	from (values
		-- Column Name                   Data Type Pattern    Nullable?
		 ('Competition_Id'              ,'smallint'          ,'NO' )
		,('Competition_Name'            ,'character varying' ,'NO' )
		,('School_Full_Points'          ,'boolean'           ,'NO' )
		,('Score_By_Level'              ,'boolean'           ,'NO' )
